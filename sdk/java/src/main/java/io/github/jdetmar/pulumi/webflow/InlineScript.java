...
import io.github.jdetmar.pulumi.webflow.InlineScriptArgs;
...
public class InlineScript extends com.pulumi.resources.CustomResource {
    /**
    ...
    private Output</* @Nullable */ String> hostedLocation;

    /**
     * @return The URI for the hosted version of the inline script (read-only). This is automatically set by Webflow after the inline script is registered.
     * 
     */
    public Output<Optional<String>> hostedLocation() {
        return Codegen.optional(this.hostedLocation);
    }
    /**
    ...
    private Output</* @Nullable */ String> integrityHash;
     ...
     * 
     */
    public Output<Optional<String>> integrityHash() {
        return Codegen.optional(this.integrityHash);
    }
    /**
     ...
     */
    public InlineScript(java.lang.String name) {
        this(name, InlineScriptArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public InlineScript(java.lang.String name, InlineScriptArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InlineScript(java.lang.String name, InlineScriptArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("webflow:index:InlineScript", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InlineScript(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("webflow:index:InlineScript", name, null, makeResourceOptions(options, id), false);
    }

    private static InlineScriptArgs makeArgs(InlineScriptArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? InlineScriptArgs.Empty : args;
    }
     ...
     */
    public static InlineScript get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
